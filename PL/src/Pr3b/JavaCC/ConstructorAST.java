...
public class ConstructorAST implements ConstructorASTConstants {
  ...
  final public Dec DeclaracionVar() throws ParseException {
    ...
    id = jj_consume_token(Id);
                                {if (true) return sem.dec_var(tipo, id);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public Dec DeclaracionTipo() throws ParseException {
    ...
    tipo = Tipo();
    id = jj_consume_token(Id);
                                     {if (true) return sem.dec_tipo(tipo, id);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public Dec DeclaracionProc() throws ParseException {
    ...
    bloque = Bloque();
                                                                     {if (true) return sem.dec_proc(id, params, bloque);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public ParamF RP(Tipo tipo) throws ParseException {
    ...
    case 46:
      jj_consume_token(46);
      id = jj_consume_token(Id);
                  {if (true) return sem.param_f_con_amp(tipo, id);}
      break;
    case Id:
      id = jj_consume_token(Id);
             {if (true) return sem.param_f_sin_amp(tipo, id);}
      break;
    default:
      jj_la1[5] = jj_gen;
      jj_consume_token(-1);
  ...
  final public ProgAux ProgramaAux() throws ParseException {
                          Prog prog;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case NumInt:
    case NumReal:
  ...
  final public Tipo TipoBasico() throws ParseException {
                      Token entero, real, booleano, str;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case Int:
      entero = jj_consume_token(Int);
                   {if (true) return sem.tipo_basico(entero.image);}
      break;
    case real:
      real = jj_consume_token(real);
                  {if (true) return sem.tipo_basico(real.image);}
      break;
    case bool:
      booleano = jj_consume_token(bool);
                      {if (true) return sem.tipo_basico(booleano.image);}
      break;
    case string:
      str = jj_consume_token(string);
                   {if (true) return sem.tipo_basico(str.image);}
      break;
    default:
      jj_la1[8] = jj_gen;
      jj_consume_token(-1);
  ...
  final public Tipo TipoArray() throws ParseException {
    ...
    jj_consume_token(of);
    tipo = Tipo();
                                                    {if (true) return sem.tipo_array(num.image, tipo);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public Campo Campo() throws ParseException {
    ...
    tipo = Tipo();
    id = jj_consume_token(Id);
                          {if (true) return sem.campo(tipo, id);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public Inst InstrInvocProc() throws ParseException {
    ...
    params = ParametrosReales();
                                               {if (true) return sem.inst_invoc_proc(id, params);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public Exp EBasica() throws ParseException {
                  Token entero, real, verdad, falso, string, id, none;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case NumInt:
      entero = jj_consume_token(NumInt);
                      {if (true) return sem.num_int(sem.str(entero.image, entero.beginLine, entero.beginColumn).lexema());}
      break;
    case NumReal:
      real = jj_consume_token(NumReal);
                    {if (true) return sem.num_real(sem.str(real.image, real.beginLine, real.beginColumn).lexema());}
      break;
    case True:
    ...
    case string:
      string = jj_consume_token(string);
                     {if (true) return sem.string(sem.str(string.image, string.beginLine, string.beginColumn).lexema());}
      break;
    case Id:
      id = jj_consume_token(Id);
             {if (true) return sem.id(sem.str(id.image, id.beginLine, id.beginColumn).lexema());}
      break;
    case Null:
  ...
  final public Exp RE5(Exp argh) throws ParseException {
    ...
    case 55:
      jj_consume_token(55);
      id = jj_consume_token(Id);
      resul = RE5(sem.exp(".", argh, id.image));
                                                         {if (true) return resul;}
      break;
    case 56:
      jj_consume_token(56);
